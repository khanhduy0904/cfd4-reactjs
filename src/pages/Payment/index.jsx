        ...
        <section className="section payment">
          ...
          <div className="payment__item">
            <div className="payment__item--wrap">
              <h2 className="title">Hình thức thanh toán</h2>
              <div className="details">
                <h3 className="sub__title">Hình thức chuyển khoản</h3>
                <div className="card">
                  - Thẻ ATM nội địa;
                  <br />
                  - Thẻ Visa, Master, JCB...;
                ...
                <h3 className="sub__title">THÔNG TIN TÀI KHOẢN:</h3>
                <ul>
                  <li>
                    {" "}
                ...
                <h3 className="sub__title">Hình thức trực tiếp</h3>
                <div className="tt">
          ...
          <div className="payment__item">
            <div className="payment__item--wrap">
              <h2 className="title">Hoàn trả học phí</h2>
              <div className="details">
                <div className="tt">
          ...
          <div className="payment__item">
            <div className="payment__item--wrap">
              <h2 className="title">Chính sách ưu đãi</h2>
              <div className="details">
                <div className="tt">
