...
import ContentCourseItem from './ContentCourseItem';
         ...
         <section className="content__course">
            <div className="container">
              ...
              <div className="info__course">
                ...
                <ContentCourseItem date="Ngày 1" title="Học HTML + CSS + BEM" dropdown="..."/>
                <ContentCourseItem date="Ngày 2" title="Học Javascript" dropdown="..."/>
                <ContentCourseItem date="Ngày 3" title="Học Git" dropdown="..."/>
                <ContentCourseItem date="Ngày 4" title="Học ES6" dropdown="..."/>
                <ContentCourseItem date="Ngày 5" title="Học " dropdown="..."/>
                <ContentCourseItem date="Ngày 6" title="Học React JS" dropdown="..."/>
              ...
              <div className="date-study">
                <h2 className="title">
                  lịch học
                  <span>
                    *Lịch học và thời gian có thể thống nhất lại theo số động
                    học viên.
                  </span>
                </h2>
                <p>
