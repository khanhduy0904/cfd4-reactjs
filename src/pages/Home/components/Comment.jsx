                  ...
                  <div className="text">
                    ...
                    <div className="text-item it2">
                      ...
                      <div className="content">
                        ...
                        được 1 web hoàn chỉnh. Mentor thì hỗ trợ nhiệt tình, lên
                        lớp học lý thuyết xong là thực chiến luôn, về nhà thì
                        livestream sửa bài, có khi tới 1-2h sáng luôn. Sau khoá
                        học thì được các mentor chia sẻ kinh nghiệm.
                      </div>
                      <div className="bottom">
                        <span className="fb">
                          <img src="img/facebook-app-symbol.svg" alt />
                    ...
                    <div className="text-item it4">
                      ...
                      <div className="content">
                        Các mentor dạy có tâm, nhiệt tình. Mình là người chưa
                        biết html và css, sau khóa học thì mình có thể tự tin
                        code được giao diện theo thiết kế và cả việc xử lí các
                        sự kiện bằng javascript và jquery.
                      </div>
                      <div className="bottom">
                        <span className="fb">
                          <img src="img/facebook-app-symbol.svg" alt />
